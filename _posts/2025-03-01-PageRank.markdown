...
<figure style="text-align: center;">
<img src="/assets/img/prfml2.png" alt="计算PR(A)<sub>1</sub>" width="600">
<figcaption>计算PR(A)<sub>1</sub></figcaption>
</figure>

<figure style="text-align: center;">
<img src="/assets/img/prfml3.png" alt="计算PR(B)<sub>1</sub>" width="600">
...
<figure style="text-align: center;">
<img src="/assets/img/prfml4.png" alt="将PR值转为矩阵" width="400">
...
<figure style="text-align: center;">
<img src="/assets/img/prfml5.png" alt="通过Marcov矩阵计算PR值" width="400">
...
<figure style="text-align: center;">
<img src="/assets/img/prfml6.png" alt="通过矩阵计算i=1时的PR值" width="400">
<figcaption>通过矩阵计算i=1时的PR值</figcaption>
</figure>

i=2时的PR值(计算完成后排名变成A, C, B, D):
<figure style="text-align: center;">
<img src="/assets/img/prfml7.png" alt="通过矩阵计算i=2时的PR值" width="400">
