...
[base]: https://terra-1-g.djicdn.com/65c028cd298f4669a7f0e40e50ba1131/Showcase/Base_LiDAR_Frames.tar.gz
  ...
  因为报错原因是没有 H_LiDAR_Map data.pcd, 
<figure style="text-align: center;">
...
<figure style="text-align: center;">
<img src="/assets/img/lidar_imatrix.png" alt="官方的粗配准外参矩阵" width="600">
...
<figure style="text-align: center;">
<img src="/assets/img/lidar-error2.png" alt="bad X server connection" width="600">
