...
仔细读官方文档: 
Zabbix中文文档: <https://www.zabbix.com/documentation/current/zh/manual/installation/>
Zabbix英文文档: <https://www.zabbix.com/documentation/current/en/manual/installation/>
...
<figure style="text-align: center;">
<img src="/assets/img/zabbix35.png" alt="" width="500">
