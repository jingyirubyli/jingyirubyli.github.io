...
<figure style="text-align: center;">
<img src="/assets/img/l9p7.png" alt="展平子树示例" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l9p8.png" alt="多路复用示例" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l9p9.png" alt="Distributed Key-Value Stores" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l9p10.png" alt="Some servers working over time while others off" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l9p14.png" alt="数据平面查询处理" width="500">
<figcaption>数据平面查询处理</figcaption>
</figure>

### 在 Switch 中实现键值缓存

使用 Match-Action 表和 Register 数组实现 KV-cache
