...
1. **At the switch:**
   ...
   - 
<figure style="text-align: center;">
<img src="/assets/img/l6p9.png" alt="IPv4 header format" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l6p10.png" alt="TCP segment header" width="300">
...
<figure style="text-align: center;">
<img src="/assets/img/l6p11.png" alt="last window size = 10; g = 1" width="300">
