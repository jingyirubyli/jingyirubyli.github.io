...
在t<sub>current</sub> = 7时作dequeue操作(“Extract-Out”): 使用filter : t<sub>current</sub> ≥ t<sub>eligible</sub> 筛选符合要求的元素, 即<font color=#008000>[13,4]</font>, [19,6], [21,2], 然后返回“rank最小的合格”元素, 即[13,4].
